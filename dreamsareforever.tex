...
``Sudanese and Congolese who put the roll in the rock // From here to Sudan, \emph{Metropolis} to Iraq" \cite{danceordie}.
...
It is disrespectful to paraphrase from \emph{Ghetto Woman}, the third track in the fifth suite of \emph{Metropolis}, as Mon\'ae's language is too rich to sample from without doing some line a disservice, but we will try.
...
An interesting contradiction in \emph{Metropolis} is Mayweather's singularity as `the One', with her politic of universal empowerment.
