...
\usepackage[backend=bibtex, style=verbose-trad2,ibidpage=true]{biblatex}
...
Janelle Mon\'ae's \emph{Metropolis} as a Historiography of Black Feminism} % Subtitle
...
It follows the story of an android (Cindi Mayweather) who falls in love with a human (Anthony Greendown) and is sentenced to death for this crime \footfullcite{wolfmasters}.
Cindi escapes her initial surprise to become a fugitive \footfullcite{manymoons}, then an underground musical icon \footfullcite{favoritefugitive}, then a society shaking radical \footfullcite{fiveseveneighttwoone}, fighting for her freedom and the freedom of her people through music and myth.
...
Evoking images and themes from Fritz Lang's Weimar classic by the same name, \emph{Metropolis} centers and shares the same tensions of class, love and revolution \footfullcite{metropolis}.
Additionally, though both have central imagery of mechanical women, Mon\'ae questions the the construction of women by their society: ``I'm a product of metal? I'm a product of the man.'' \footfullcite{happyhunting}. 
Rather than having mechanical women as a means of controlling the proletariat, as in Lang's work \footfullcite{metropolis}, Mon\'ae's Android heroine realizes her mission and capability to win the freedom of the oppressed.
...
``You know the rules!'' \footfullcite{wolfmasters}, the singsong establishment chides.
...
Audre Lorde describes this tradition in her essay \emph{Scratching the Surface}: ``If we do not define ourselves for ourselves, we will be defined by others-for their use and to our detriment'' \footfullcite{lordescratching}.
...
Between the arcane and specific rules issued for her capture (`chainsaws and electro-daggers!' \footfullcite{wolfmasters}), and the casual tone, the implications of slavery are clear, particularly within the context of the stripped humanity of fugitive slave laws.
...
We should not forget that postcards of lynchings are not a feature of the archaic past \footfullcite{lynching}, and violence predicated on sexual identity and preference is still very much alive \footfullcite{wikipediatransmurders}.

In the world of \emph{Metropolis}, love is consequential.
In bell hooks' treatise on love, power and relationships \emph{All About Love: New Visions}, a central theme is that love cannot exist within a power imbalance; that the fundamental nature of love as a verb, as a practice of care and intimacy, places as a prerequisite the full and equal humanity and dignity of its participants \footfullcite{newvisions}. 
...
This is the exact same (racist) logic that fortified interracial marriage bans until 1967 \footfullcite{wikipediaantimiscegenation} (and interracial love, as how can we have one without the other?).
...
% Before she becomes ``An outlaw, out running the law'' \footfullcite{neonvalleystreet}, she is thrust into a world she had thought ``impossible!'' \footfullcite{happyhunting}, a world where the concept of her safety and agency is radical and revolutionary.
...
Cindi Mayweather laments her use as a sexualized humanoid, and her simultaneous lack of access to the more meaningful (yet somehow associated) pursuit of love: ``A pretty face makes a pretty picture, but fall in love and they're coming to get you'' \footfullcite{happyhunting}.
She calls for her freedom, and bootstrap ideologies croon back, faulting her as the source of her enslavement: ``I keep my feet on solid ground. Freedom, Freedom, Freeeeedom! // \emph{Your free but in your mind, Your freedom's in a bind!}'' \footfullcite{manymoons} (emphasis mine to denote multiple voices).
A characteristic of the first wave of Black Feminism was the consistent deafness to the voices of black women, from W.E.B Du Bois' lack of citationality for the brilliance of Anna Julia Cooper \footfullcite{dubois} continuing far too long into the second (and to a degree, third) waves of Black Feminism, with Angela Davis' marginalization within the Black Panther Party.
Mayweather faces this struggle, and is given the means to amplify her voice (a microphone) only when a man grants it: ``let me just hear you squeak'' \footfullcite{manymoons}.
Later in \emph{Metropolis}, she is no longer reliant on men to broadcast her message (a change that can be seen in her interactions with WDRD in the fourth and fifth suites)\footfullcite{goodmorningmidnight}, a representation of Black Feminism as an emerging, and distinct thread of ideology and agitation. 
...
%``And when the world just treats you wrong // just come with me and I'll take you home'' \footfullcite{manymoons}.

Mon\'ae continues her tour through the first wave of Black Feminism by citing the Baptist tradition of respectability politics described in our course by Higginbotham \footfullcite{higginbotham}.
...
``These kids round' killin each other, they lost they minds, they gone. They quittin' school, making babies and can barely read. Some gone off to their fall, lord have mercy on them'' \footfullcite{sincerelyjane}.
...
Rather than focusing on the systemic injustices which create and maintain the oppression of the marginalized, Mayweather's mother cites the failings of their community in trying to mirror norms of `normal' society\footfullcite{sincerelyjane}.
...
While the majority of \emph{Metropolis} focuses on the ways that justice is \emph{structurally} denied to oppressed communities (both android and black) \footfullcite{queen}, \emph{Sincerely, Jane.} recognizes and airs out the respectability argument without advocating for it.
...
``We can't go fighting wars with hearts of hatred, our nation's greed won't make it better, or quiet the fear in our hearts'' \footfullcite{mrpresident}.
...
``Fuel is running low, and I've got places to go'' \footfullcite{mrpresident}.

Complimentarily, in \emph{Smile}, Mon\'ae (or perhaps Mayweather) offers us a beautiful, crushing, view into the culture of dissemblance described by Darlene Clark Hine \footfullcite{hine}.
``Smile, though your heart is aching // Smile, even though it's breaking'' \footfullcite{smile}.
...
``Smile, through all fear and sorrow // Smile and may be tomorrow // You'll find the sun come shining through // For you'' \footfullcite{smile}.
...
In the scene `i'm a poet who', the lady in orange says that ``we gotta dance to keep form cryin and dyin'' \footfullcite{forcoloredgirls}, another use of external joy as a mask and a relief from tragedy.
...
``You must keep on trying // Smile, whats the use of crying // You'll find that life is still worthwhile // If you just smile'' \footfullcite{smile}.
...
No wonder Mayweather later notes to her lover ``I know I'm mysterious sometimes, and you are mysterious too'' \footfullcite{primetime},
...
``When you get elevated, they love it or they hate it... They tryin' to take all of your dreams but you can't allow it'' \footfullcite{tightrope}.
...
``Just keep rebelling away, you gotta dream it away // Because the weatherman on TV ain't creating the weather'' \footfullcite{danceordie}. 
...
``This is a cold war, do you know who you're fighting for?'' \footfullcite{coldwar}.
...
There's a war in all the streets and yes the freaks must dance or die!'' \footfullcite{danceordie}.
...
``Call me weak, or better yet you can call me // you can call me your hero, baby'' \footfullcite{faster}.
This reminds me of Anna Julia Cooper's 1892 remarks about the spaces that black women inhabit:
``Only the black woman can say `when and where I enter, in the quiet, undisputed dignity of my womanhood, without violence and without suing or special patronage, then and there the whole...race enters with me''' \footfullcite{cooper1892}.
...
In \emph{Oh Maker}, Mayweather talks to her maker (god? engineer? mother?) about love, beauty and loss, and the toll it exacts on her \footfullcite{ohmaker}.
...
``I'm trying to find my peace.  I was made to believe there's something wrong with me! And it hurts my heart, lord have mercy, ain't it plain to see?'' \footfullcite{coldwar}.
What is obvious to Mayweather (and Mon\'ae) is somehow hard for others to see, tying into questions of sanity and reaction that are evoked in Claudia Rankine's discussion of Serena Williams and Zinedine Zidane in \emph{Citizen: an American Lyric} \footfullcite{citizen}.
...
They say she is a mess, that she needs to take her meds, but Mayweather just describes herself as `coming alive' \footfullcite{roses}.
...
``I'm locked inside a land called foolish pride // where the man is always right // he hates to talk but loves to fight // is that alright?'' \footfullcite{lockedinside}
...
In \emph{Wondaland}, Mon\'ae's singsong narrator implores: ``Take her back to wondaland, she thinks she left her underpants'' \footfullcite{wondaland}.
In \emph{Make The Bus}, Mayweather is confessing that she has ideas and temptations that she feels she ought avoid:
``I've got this terrible fixation // ... // just want to keep it in the realm of fantasy'' \footfullcite{makethebus}.
By starting with open and honest, unapologetic discussions on sex (``This is your life. This is my life. We belong here, stay the night'' \footfullcite{wondaland}) 
Mon\'ae centers sex as both a natural part of a young black woman's journey, and sets the stage to discuss its misuse.

In \emph{Neon Valley Street} Mayweather reminisces on her and Greendown's past (on the street where she had lived before her fugitive life), and the elaborate, intricate, careful detail she has placed in to her affection and care reverberates through a piece which showcases her masterful artistry \footfullcite{neonvalleystreet}.
...
In \emph{Say You'll Go}, Mayweather implores her partner to be willing to pursue love as a destination ``few people go or ever know'' \footfullcite{sayyouwillgo}, with the knowledge of its challenges and scarcity.
...
But Mayweather knows that in asking her partner to `say he'll go', there is a question of power associated: ``Who will lead? Who will follow?''
 \footfullcite{sayyouwillgo}, echoing bell hooks' language on power, love, and trust discussed above in \emph{New Visions} \footfullcite{newvisions}.
Power and love are frequently at play in \emph{Metropolis}, and from what little we have of their relationship, it seems as if Mayweather is calling the shots, while Greendown has the agency to execute on them because of his relative power as a human: ``Sir Greendown // Let's leave in an hour // Meet me at the tower // Ride your horse'' \footfullcite{greendown}.
This power imbalance is always at the heart of her questions on love, and hooks, as mentioned before, questions whether love can ever truly exist as a process between people with any sort of power over one another \footfullcite{newvisions}.
...
``How different things might be if, rather than saying `I think I'm in love,' we were saying `I've connected with someone in a way that makes me think I'm on the way to knowing love.' Or if instead of saying `I am in love' we say `I am loving' or `I will love'. Our patterns around romantic love are unlikely to change if we do not change our language.'' \footfullcite{newvisions}.
Similarly, Mon\'ae is careful to avoid using love as an object, treating it alternatingly as a verb and as an objective: ``Tell me are you bold enough to reach for love?'' \footfullcite{manymoons}.
...
However, the song crecendos to a peak and immediately simmers to a cool, where Mayweather offers us the only hint to darker tones of their relationship: ``This time I shall be unafraid // And violence will not move me'' \footfullcite{babopbyeya}.
...
The question of whether or not to discuss domestic violence within the black community was a debate which showed the need for a new wave of Black Feminism \footfullcite{rebeccawalker}.
...
In \emph{Outlaw Culture: Resisting Representations}, bell hooks gives us the language to describe how domestic abuse as a mechanism of power is perpetuated by the `seduction of violence', from which the tenth chapter gains its name \footfullcite{hooks1994outlaw}.
...
Without this element in her life, she sees ``beyond tomorrow // This life of strife and sorrow // My freedom calls and I must go'' \footfullcite{babopbyeya}.
...
In \emph{New Visions}, hooks paints this decision within the context of love: ``All too often women believe it is a sign of commitment, an expression of love, to endure unkindness or cruelty, to forgive and forget. In actuality, when we love rightly we know that the healthy, loving response to cruelty and abuse is putting ourselves out of harm's way'' \footfullcite{newvisions}.

Just like the Anita Hill testimony awoke the Third Wave of Black Feminism in the form of Rebecca Walker \footfullcite{rebeccawalker} (a pun on her claim of embodiment, not a singular citation), Mayweather's decision to leave Anthony is an inflection point in \emph{Metropolis}.
...
The first interlude has two call ins, one from an android woman who is living Cindi's vision of resistance ``break some rules, just like Cindi'', the second of whom is a male droid (Bop Bot Say-What), who plans on ``hittin' someone in the head'' \footfullcite{goodmorningmidnight}.
DJ Crash Crash makes it clear that the first vision of resistance is great, but challenges the second as some ``rusty dusty, nano-thinkin' nonsense'' \footfullcite{goodmorningmidnight}.
...
``I'm praying for the man sitting without much time // May he understand the clock will never rewind // Wisen him and sharpen him and give him a motto // hate no more, said he must hate no more'' \footfullcite{danceordie}.
...
Nonviolence is a choice, and a strategic choice, one that Mayweather has made for herself  but also for her movement: ``I use my words when stones come around'' \footfullcite{manymoons}.
...
``Sudanese and Congolese who put the roll in the rock // From here to Sudan, Metropolis to Iraq'' \footfullcite{danceordie}.
Throughout, Mayweather demands that apathy is not acceptable, in questioning us each to think ``who we are fighting for'' in \emph{Cold War} \footfullcite{coldwar}.
Moreover, Mayweather makes clear that ability should be the only thing getting in the way of activism: 
``March to the streets 'cause I'm willing and I'm able'' \footfullcite{queen}.
...
In the \emph{Chrome Shoppe} Interlude, one of the female androids is named `Assatta' \footfullcite{chromeshoppe}, and in in Q.U.E.E.N., Mayweather speaks to her aspirations to ``keep leading like a young Harriet Tubman'' \footfullcite{queen}.
In one of the pivotal moments in the fourth suite, she asks the black woman to ``Wake up Mary'' \footfullcite{sallyride}, in a song titled after Sally Ride, with the impact of that awakening clear yet ambiguous: ``some amazing news // you've got the right to choose'' \footfullcite{sallyride}. 
Awakening was a key theme of the first suite (``Day dreamers please wake up, we can't sleep no more.'' \footfullcite{sincerelyjane}) and it is revived in the form of a request, now as a choice rather than an imperative, as Mayweather begins her revolution and seeks participants: ``Electric Ladies will you sleep? Or will you preach?'' \footfullcite{queen}.
...
``Is it weird to like the way she wears her tights?'' \footfullcite{queen}.
...
``Quare theory [in contrast to Queer theory] promises to  reduce the spillage, allowing the various and multiple flavors to co-exist--those different flavors that make it spicy, hot, unique and sumptuously brown'' \footfullcite{johnson2001quare}.
...
``Would your god accept me in my black and white? Would he approve the way I'm made? Or should I reprogram reprogram and get down?!?'' \footfullcite{queen}.
...
``She'd keep it to herself and nobody could understand her // Even when she thought that she couldn't she carried on // She couldn't imagine both of her daughters here all alone'' \footfullcite{ghettowoman}.
...
``I wish they could just realize // That all you've ever needed was someone to free your mind // Carry on Ghetto Woman // Cause even in your darkest hours I still see your light'' \footfullcite{ghettowoman}.
...
``The silver bullet's in your hand and the war's heating up'' \footfullcite{manymoons}.
...
Evidence for this hypothesis comes from \emph{Sally Ride}, where Mayweather undergoes a personal crisis that makes her question her powers and strength:
 ``Take me to the river, my soul is looking for a word from God // Oh God, like a rose in the cold // will I rise?'' \footfullcite{sallyride}.
Mayweather feels she needs to distance herself from her work, to find internal peace and move on from her work:
 ``I know you love me but I'm still gone. I've got to make my peace, I've got to move on''\footfullcite{sallyride}.
...
In \emph{Victory}, Mayweather comes to the realization that ``to be victorious, you must find glory in the little things''\footfullcite{victory}.
Mayweather, upon learning that she is not the one, realizes that she has still contributed toward the collective goal, that even though she is not a deity, her strength and perseverance have made a huge impact, and she views this revelation within the context of self growth: 
 ``Cause when the rain falls // My seed will grow // I'll be further to my dreams tomorrow'' \footfullcite{victory}.
 ...
 ``Although the black feminist movement is not where I envisioned it might be during those first exciting days, it is obvious that our work has made a difference. Radical political change more often happens by increments than through dramatically swift events. Indeed, dramatic changes are made possible by the daily, unpublicized work of countless activists working on the ground'' \footfullcite{smithhomegirls}.
 ...
 In \emph{Dorothy Dandridge Eyes}, the idea that Mayweather is not `the One' is simultaneously pointed out and made irrelevant by highlighting the things which make her unique and special \footfullcite{dandridgeeyes}.
...
%``Indivisible Sum // Here's the book, now the saga's begun'' \footfullcite{fiveseveneighttwoone}
%``A long long way to find the one // We'll keep on dancing till she comes // These dreams are forever'' \footfullcite{danceordie}
%``I want to know if you believe Cindi Mayweather is not only just electric lady, number one and all, but also the ArchAndroid?'' \footfullcite{favoritefugitive}
%``Heaven is betting on us.'' \footfullcite{primetime}

%Ending on a celebration of her unique features \footfullcite{dandridgeeyes}, and a party \footfullcite{whatanexperience}
...
``She who writes the movie owns the script and the sequel'' \footfullcite{queen}.
Collins, In her 1986 paper \emph{Learning from the Outsider Within: The Sociological Significance of Black Feminist Thought}, describes how black women (in academia, as well as intellectuals more broadly) have used their unique position as `outsiders within' to shape sociological theory \footfullcite{collins86}.
One of the three components of Collins' analysis is how black women have used their standpoint to ``challenge the political knowledge-validation process'' (Self-Definition), and ``replace externally-derived images with authentic Black female images'' (Self-Valuation) \footfullcite{collins86}.
...
In encouraging her daughter to not let her resistance get in the way of her personal success, hooks describes her mother's warning as ``reminding me of the necessity of opposition and simultaneously encouraging me not to lose that radical perspective shaped and formed by marginality'' \footfullcite{hookschoosing}.
...
Their collaborations, including \emph{My First Love}, \emph{Peachtree Blues} and \emph{2012}, feature Mon\'ae's stunning voice over the band's signature modern jazz sound \footfullcite{peachtreeblues} \footfullcite{myfirstlove}.
...
``We see black or white // polkadots or stripes // Freedom we deny // lets open our eyes'' \footfullcite{polkadottedstripe}.
Mon\'ae questions dichotomies and categorization throughout the \emph{Metropolis} suite, through explicit and subtle means.
Though not always as clear as in Q.U.E.E.N. (``Categorize me, I defy Every Label!'' \footfullcite{queen}), 
...
``We're growing up in the iPod generation in terms of genres. I do away with labels and categories. I don't believe in them ... That was created by man.'' \footfullcite{joeyguerra2010}.
...
In their 2002 work on how girls of color can be intentionally educated and counseled to thrive in systems which frequently invalidate their experiences, Iglacias and Cormer discuss the adolescent transition as one that is rooted in struggle for girls of color, and that ``A girl who will develop as a woman who embraces freedom has a strong sense of self-confidence and self-efficacy'' \footfullcite{iglesiascormier}.
...
Mon\'ae translates academic language about matrices of domination into common sense (and catchy) lyrics which galvanize their repetition and prominence: ``Add us to equations but they'll never make us equal'' \footfullcite{queen}, and in doing so brings Black Feminist theory and common parlance closer together.
...
%BOOK IDEAS:
%
%''The true focus of revolutionary change is never merely the oppressive situations which we seek to escape, but that piece of the oppressor which is planted deep within each of us.'' \footfullcite{lordredefiningdifference} 
%
%``What lies between the lines are the things that women of color do not tell each other. There are reasons for our silences: the change in generation between mother and daughter, the language barriers between us, our sexual identity, the educational opportunities we had or missed, the specific cultural history of our race, the physical conditions of our bodies and the labor... We begin by speaking directly to the deaths and disappointments. Here we begin to fill in the spaces of silence between us. For it is between these seemingly irreconcilable lines--the class lines, the politically correct lines, the daily lines we run down to each other to keep difference and desire at a distance--that the truth of our connection lies.'' \footfullcite{thebridge}
%
%``As women we have been taught to either ignore our differences or to view them as causes for separation and suspicion rather than as forces for change. Without community, there is no liberation, only the most vulnerable and temporary armistice between an individual and her oppression. But community must not mean a shedding of our differences, not the pathetic pretense that these differences do not exist.'' \footfullcite{lorde2003master}
%
%
%
%
%``If any female feels she need anything beyond herself to legitimate and validate her existence, she is already giving away her power to be self-defining, her agency.'' \footfullcite{hooksforeveryone}
